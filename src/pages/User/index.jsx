        ...
        <main className="vertical ai-center g4">
            ...
            <section className="surface fade-anim vertical">
                ...
                <div className="avatar-section horizontal g4">
                    <div className="avatar-img center">
                        <span className="text-4xl font-title text-yellow-800">KR</span>
                        <div className="avatar-upload-btn center pointer" >
                    ...
                    <div className="vertical g2">
                        <div className="vertical">
                            <h3 className="title text-yellow-800">Kauan Rodrigues Oliveira</h3>
                            <p className="subtitle">kauanrdx145@gmail.com</p>
                        </div>
                        <div className="horizontal g1">
                            <button className="button secondary hover-yellow" >Alterar foto</button>
            ...
            <div className="surface fade-anim vertical">
                ...
                <div className="horizontal g4">
                    <div className="stat-card">
                        <h2 className="title text-yellow-800">1</h2>
                        <h3 className="subtitle">Tarefas criadas</h3>
                    </div>
                    <div className="stat-card">
                        <h2 className="title text-yellow-800">0</h2>
            ...
            <section className="surface fade-anim vertical">
                ...
                <div className="field-group">
                    ...
                    <div className="horizontal g1 ai-center">
                        <span className="input-icon">
                            <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,12 2,6"></polyline></svg>
                        </span>
                        <input
                            className="input"
                            type="email"
                ...
                <div className="horizontal g1 jc-end">
                    ...
                    <button className="button" type="submit">
                        <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline></svg>
                        Salvar alterações
                    </button>
                </div>
            </section>
            ...
            <section className="surface danger fade-anim vertical">
                ...
                <div className="preference-row">
                    ...
                    <button className="button bg-red" onclick="confirmDanger('limpar')">Limpar tarefas</button>
                </div>
                <div className="preference-row">
                    <div>
                    ...
                    <button className="button bg-red" onclick="confirmDanger('excluir')">Excluir conta</button>
                </div>
            </section>
